import { View, StyleSheet, Text, Alert, TextInput, ActivityIndicator, KeyboardAvoidingView, Platform, TouchableOpacity, ScrollView, LayoutAnimation, UIManager } from "react-native";
...
export default function App() {
    ...
    // 🎧 Écoute les changements d'état de l'authentification (Connexion/Déconnexion)
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
            setUser(currentUser);
            // Optionnel : Redirection auto si besoin, mais les onglets gèrent déjà la navigation
        });
        return () => unsubscribe();
    }, []);
    ...
    // 🟢 VUE CONNECTÉ : Affiche le profil utilisateur
    if (user) {
        return (
